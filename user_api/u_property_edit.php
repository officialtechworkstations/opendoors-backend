...
$party_allowed = $data['party_allowed'] ? 1 : 0;
$party_cost = $data['party_cost'];
$caution_fee = $data['caution_fee'];

if (
    $prop_id == "" or $pbuysell == "" or $country_id == "" or $plimit == "" or
    $user_id == "" or $status == "" or $title == "" or $address == "" or
    $description == "" or $ccount == "" or $facility == "" or $ptype == "" or
    $beds == "" or $bathroom == "" or $sqft == "" or $rate == "" or $latitude == "" or
    $mobile == "" or $listing_date == "" or $price == "" or ($party_allowed == 1 && !$party_cost)) {
    $returnArr = [
        "ResponseCode" => "401",
        "Result" => "false",
    ...
    if ($check_owner != 0) {
        if ($data["img"] == "0") {
            ...
            $where =
                "where id=" . $prop_id . " and add_user_id=" . $user_id . "";
            $h = new Estate();
