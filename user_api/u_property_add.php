...
if ($user_id == '' or $pbuysell == '' or $country_id == '' or $plimit == '' or $status == '' or $title == '' or $address == '' or $description == '' or $ccount == '' or $facility == '' or $ptype == '' or $beds == '' or $bathroom == '' or $sqft == '' or $rate == '' or $latitude == '' or $mobile == '' or $listing_date == '' or $price == '' or ($party_allowed == 1 && !$party_cost)) {
    $returnArr = array(
        "ResponseCode" => "401",
        "Result" => "false",
