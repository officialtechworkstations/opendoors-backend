									...
									<div class="row">
										...
										<div class="form-group mb-3 col-4">
											...
											<select class="form-control" name="sms_type">
												...
												<option value="Termii" <?php if($set['sms_type'] == 'Termii'){echo 'selected';}?>>Termii</option>
											</select>
										</div>
										...
										<div class="form-group mb-3 col-12">
											<h5 class="h5_set"><i class="fas fa-sms"></i> Termii Sms Configurations </h5>
										</div>
										<div class="form-group mb-3 col-4">
											<label><span class="text-danger">*</span> Termii Base URL</label>
										...
										<div class="form-group mb-3 col-12">
											<h5 class="h5_set"><i class="fa fa-warning" aria-hidden="true"></i> User Notice</h5>
										</div>
										<div class="form-group mb-3 col-12">
